...
namespace Core.Containers
{
    ...
    public unsafe struct LinkedNode<TUnmanaged> : IDisposable where TUnmanaged : unmanaged
    {
        ...
        private AllocationOwner<LinkedNode<TUnmanaged>> Owner => new AllocationOwner<LinkedNode<TUnmanaged>>(_next);
        ...
        )
        {
            ...
            var allocation = Allocation.Initialize<LinkedNode<TUnmanaged>>
            (
